  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('home.index')}}" style="font-weight:800; ">Automotriz R.A.L.E</a>
        <a class="navbar-brand brand-logo-mini" href="{{route('home.index')}}"><img src="{{asset('assets/images/car.png')}}" alt="logo"/></a>
      </div>
        ...
        <div class="tab-content" id="setting-content">
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              ...
              <li class="list">
                <div class="profile"><img src="{{asset('assets/images/avatar/avatar.png')}}" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="{{asset('assets/images/avatar/avatar.png')}}" alt="image"><span class="online"></span></div>
                <div class="info">
        ...
        <ul class="nav">
          ...
          {{-- <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#page-layouts7" aria-expanded="false" aria-controls="page-layouts">
              <i class="fab fa-trello menu-icon" style="color:black;!important"></i>
              <span class="menu-title" style="color:black;!important">Abonos</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="page-layouts7">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="{{route('admin.agregarAbono')}}">Abonar</a></li>
              </ul>
            </div>
          </li> --}}
@endif
...
@if(auth()->user()->hasRole('Administrador'))
          <li class="nav-item">
            ...
            <div class="collapse" id="page-layouts">
              <ul class="nav flex-column sub-menu" style="list-style:none !important;">
                <li class="newitem d-none d-lg-block"> <a class="nav-link" href="{{route('categoria.create')}}">Agregar categoría</a></li>
           ...
           <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#page-layouts3" aria-expanded="false" aria-controls="page-layouts">
              <i class="fab fa-trello menu-icon" style="color:black;!important"></i>
            ...
            <div class="collapse" id="page-layouts3">
              <ul class="nav flex-column sub-menu">
                <li class="newitem d-none d-lg-block"> <a class="nav-link" href="{{route('inventario.create')}}">Agregar inventario</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="page-layouts2">
              <ul class="nav flex-column sub-menu">
                <li class="newitem d-none d-lg-block"> <a class="nav-link" href="{{route('producto.create')}}">Agregar producto</a></li>
                <li class="newitem"> <a class="nav-link" href="{{route('producto.index')}}">Ver productos</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#page-layouts6" aria-expanded="false" aria-controls="page-layouts">
            ...
            <div class="collapse" id="page-layouts6">
              <ul class="nav flex-column sub-menu">
                <li class="newitem d-none d-lg-block"> <a class="nav-link" href="{{route('admin.agregarMiembro')}}">Agregar miembro</a></li>
